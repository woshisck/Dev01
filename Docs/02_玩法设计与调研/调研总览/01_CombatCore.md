...
- **设计文档**：[AttackDamage_ConfigGuide](../../04_开发实现与系统文档/系统/Combat/AttackDamage_ConfigGuide.md)
- **验收方式**：
...
- **设计文档**：[HitStop_Design](../设计文档/Combat/HitStop_Design.md)
...
- **设计文档**：[Dash_Design](../../04_开发实现与系统文档/系统/Combat/Dash_Design.md)
...
- **设计文档**：[FeatureLog FEAT-033](../../05_完成记录与任务看板/FeatureLog.md)
...
- **设计文档**：[SkillCharge_Guide](../../04_开发实现与系统文档/系统/Combat/SkillCharge_Guide.md)
...
- **设计文档**：[PoiseSystem_ConfigGuide](../../04_开发实现与系统文档/系统/Combat/PoiseSystem_ConfigGuide.md)
...
- **设计文档**：[CharacterFlash_Technical](../../04_开发实现与系统文档/系统/VFX/CharacterFlash_Technical.md)
...
- **设计文档**：[Systems/CodeCatalog](../../04_开发实现与系统文档/系统/CodeCatalog.md)
...
- **设计文档**：[Systems/AI/](../../04_开发实现与系统文档/系统/AI)
...
- **设计文档**：[EnemyCombo_ConfigGuide](../../04_开发实现与系统文档/系统/Combat/EnemyCombo_ConfigGuide.md)
...
| ID | 内容 | 文档 |
|---|---|---|
| ENEMY-DA-002 | 所有 `DA_Enemy_*` → Enemy\|Poise → 填 `SuperArmorThreshold`（建议 3）+ `SuperArmorDuration`（建议 2s） | [TASKS](../../05_完成记录与任务看板/PM/TASKS.md) |
| VFX-005（玩家蒙太奇）| 玩家攻击蒙太奇命中帧添加 `AN Hit Stop`（轻攻 F=50ms；重攻 F=80ms/S=120ms@25%） | [TASKS](../../05_完成记录与任务看板/PM/TASKS.md) |
| VFX-004（敌人蒙太奇）| 敌人攻击蒙太奇前摇帧拖入 `ANS Pre Attack Flash` 区间 | [CharacterFlash_Technical](../../04_开发实现与系统文档/系统/VFX/CharacterFlash_Technical.md) |
