...
- **设计文档**：[LevelSystem_ConfigGuide](../../04_开发实现与系统文档/系统/Level/LevelSystem_ConfigGuide.md) · [LevelSystem_ProgrammerDoc](../../04_开发实现与系统文档/系统/Level/LevelSystem_ProgrammerDoc.md)
- **验收方式**：
...
- **设计文档**：[BuffPool_ConfigGuide](../../04_开发实现与系统文档/系统/Level/BuffPool_ConfigGuide.md)
...
- **设计文档**：[CrossLevelState_Technical](../../04_开发实现与系统文档/系统/Level/CrossLevelState_Technical.md)
- **验收方式**：
...
| ID | 内容 | 文档 |
|---|---|---|
| LEVEL-006 WBP（A）| 创建 `WBP_PortalPreview`（父类 `UPortalPreviewWidget`）按 Layout 规格搭建 | [WBP_PortalPreview_Layout](../../04_开发实现与系统文档/系统/Level/WBP_PortalPreview_Layout.md) |
...
| LEVEL-END-CONFIG | 创建 `WBP_LevelEndReveal`（全屏 Image 命名 RevealImage）+ `DA_LevelEndEffect` + 配置 BP_YogHUD | [TASKS](../../05_完成记录与任务看板/PM/TASKS.md) |
