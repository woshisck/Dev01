...
- **设计文档**：[CharacterFlash_Technical](../../04_开发实现与系统文档/系统/VFX/CharacterFlash_Technical.md) · [Material_Authoring_Guide](../../04_开发实现与系统文档/系统/VFX/Material_Authoring_Guide.md)
- **验收方式**：
...
- **设计文档**：[Camera_Design](../../04_开发实现与系统文档/系统/Camera/Camera_Design.md)
- **验收方式**：
...
- **设计文档**：[Material_Authoring_Guide](../../04_开发实现与系统文档/系统/VFX/Material_Authoring_Guide.md)（详细规范）· memory: `reference_material_authoring.md`（已有正式文档不需转写）
...
| ID | 内容 | 文档 |
|---|---|---|
| ENEMY-DA-001 | 所有 `DA_Enemy_*` → Enemy\|Spawn → 填 `PreSpawnFX` (NS_EnemySpawn) + `PreSpawnFXDuration`(0.8~1.5s) | [TASKS](../../05_完成记录与任务看板/PM/TASKS.md) |
| VFX-006 | 所有敌人 BP Details → Combat\|Visual → `CharacterFlashMaterial` 填入 Overlay 材质 | [CharacterFlash_Technical](../../04_开发实现与系统文档/系统/VFX/CharacterFlash_Technical.md) |
