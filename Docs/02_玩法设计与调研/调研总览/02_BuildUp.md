...
- **设计文档**：memory: `project_rune_upgrade_design.md` （**待转写**为 `Docs/04_开发实现与系统文档/系统/Rune/RuneUpgrade_Design.md`）
...
- **设计文档**：[BuffFlow_NodeUsageGuide](../../04_开发实现与系统文档/系统/Rune/BuffFlow_NodeUsageGuide.md) · [RuneLogic_Complete_Guide](../../04_开发实现与系统文档/系统/Rune/RuneLogic_Complete_Guide.md)
...
- **设计文档**：[FA_UniversalArchitecture](../../04_开发实现与系统文档/系统/Rune/FA_UniversalArchitecture.md)

### [BuffFlow CustomInput DataPin] 子图父图传参
- **设计需求**：模块化拆分 FA 时要能跨图传值，不必把所有逻辑塞一张图。
- **状态**：✅ C++完成
- **设计文档**：[BuffFlow_CustomInputDataPin](../../04_开发实现与系统文档/系统/Rune/BuffFlow_CustomInputDataPin.md)
...
- **设计文档**：[GameplayTag_MasterGuide](../../04_开发实现与系统文档/标签/GameplayTag_MasterGuide.md) · [Tag_SituationalGuide](../../04_开发实现与系统文档/标签/Tag_SituationalGuide.md)
...
- **设计文档**：[StateConflict_TagBlock](../../04_开发实现与系统文档/标签/StateConflict/StateConflict_TagBlock.md) · [StateConflict_Technical](../../04_开发实现与系统文档/标签/StateConflict/StateConflict_Technical.md)
...
| ID | 内容 | 文档 |
|---|---|---|
| HEAT-CARRY-001 | `FA_Rune_余烬`：`Start → BFNode_GrantTag(Buff.HeatCarry.OnePhase)` | [TASKS](../../05_完成记录与任务看板/PM/TASKS.md) |
| HEAT-CARRY-002 | `FA_Rune_炽核`：`Start → BFNode_GrantTag(Buff.HeatCarry.TwoPhase)` | [TASKS](../../05_完成记录与任务看板/PM/TASKS.md) |
| ALTAR-001 | 创建 `DA_Altar_EventRoom`（`UAltarDataAsset`），填献祭符文池 + 代价文字 | [TASKS](../../05_完成记录与任务看板/PM/TASKS.md) |
...
| RUNE-P0-1/2/3 | 1017 / 1018 / 1019 高感知测试符文 FA | [TestRune_HighPerception_Guide](../../04_开发实现与系统文档/系统/Rune/TestRune_HighPerception_Guide.md) |
