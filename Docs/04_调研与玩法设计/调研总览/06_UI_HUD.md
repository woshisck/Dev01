...
- **设计文档**：[BackpackSystem_Guide](../../99_归档/旧方案/2D背包方案/BackpackSystem_Guide.md) · memory: `project_backpack_ui_arch.md`（旧 2D 背包方案已归档；如需重写，请放入 `Docs/01_长期系统文档/系统/Rune/`）
- **验收方式**：
...
- **设计文档**：[LootSelection_Technical](../../01_长期系统文档/系统/UI/LootSelection_Technical.md)
...
- **设计文档**：[WeaponPickupAnim_Technical](../../01_长期系统文档/系统/UI/WeaponPickupAnim_Technical.md)
...
- **设计文档**：[GlassFrame_Technical](../../01_长期系统文档/系统/UI/GlassFrame_Technical.md)
...
- **设计文档**：[TutorialPopup_Copy](../../01_长期系统文档/系统/UI/TutorialPopup_Copy.md)（文案）
- **验收方式**：
...
| ID | 内容 | 文档 |
|---|---|---|
| HUD-001 | 创建 `WBP_HUDRoot`（Parent = `YogHUDRootWidget`）+ `WBP_PlayerHealthBar`（Parent = `LiquidHealthBarWidget`），配 BP_YogHUD → `MainHUDClass` | [TASKS](../../05_项目管理与进度/PM/TASKS.md) |
| UI-001 | `WBP_WeaponGlassIcon` + `WeaponGlassAnimDA` 编辑器配置 | [WeaponPickupAnim_Technical](../../01_长期系统文档/系统/UI/WeaponPickupAnim_Technical.md) |
| UI-002 | `WBP_WeaponTrail` 创建（根全屏 Canvas + Image 命名 TrailLine + M_WeaponTrail） | 同上 |
| FIX-028 配置 | HB_PlayerMain Details → Enemy Arrow → `EnemyArrowWidgetClass` 赋 WBP_EnemyArrow | [FeatureLog FIX-028](../../05_项目管理与进度/FeatureLog.md) |
| FIX-010 | `WBP_WeaponFloat` 白屏 Bug：将背景移入 InfoContainer | [FeatureLog FEAT-015](../../05_项目管理与进度/FeatureLog.md) |
