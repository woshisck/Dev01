...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Celes Light|Stylized Character")
	EStylizedCharacterLightMode CharacterLightMode = EStylizedCharacterLightMode::Toon;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Celes Light|Stylized Character", meta = (ClampMin = "0.0", ClampMax = "1.0"))
	float CharacterShadowStrength = 1.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Celes Light|Stylized Character", meta = (ClampMin = "0.25", UIMin = "0.25", UIMax = "16.0"))
	float CharacterRimPower = 4.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Celes Light|Stylized Character", meta = (ClampMin = "0.0", UIMin = "0.0", UIMax = "8.0"))
	float CharacterRimIntensity = 1.0f;
