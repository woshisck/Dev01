...
{	
	...
	const IPrimitiveComponent* PrimitiveComponentInterface = nullptr;
	...
	uint32 bVisibleInReflections : 1;
	...
	uint32 bCastShadowOnOtherObjectsOnly : 1;
	...
	uint32 bUsePSOPrecacheFallbackMaterial:1;	
#if WITH_EDITOR
	...
	TArray<FMaterialPSOPrecacheRequestID> MaterialPSOPrecacheRequestIDsToBoostOnDraw;
	...
	{
		return bUsePSOPrecacheFallbackMaterial;
	}
	...
	ENGINE_API void SetPSOPrecacheComponentData(const FPSOPrecacheComponentData& PrecacheComponentData);
	...
	UE_DEPRECATED(5.8, "Use FPrimitiveSceneProxyDesc::UsePSOPrecacheFallbackMaterial() instead.")
	bool ShouldRenderProxyFallbackToDefaultMaterial() const
	{
		return UsePSOPrecacheFallbackMaterial();
	}
};
