...
enum EMaterialFloatPrecisionMode : int
{
	...
	/** Half precision, except explicit 'float' in .ush/.usf*/
	MFPM_Half UMETA(DisplayName = "Use Half-precision"),
	/* Same as 'Half precision' but includes custom shader parameters uniforms */
	MFPM_Half_WithShaderParameters UMETA(DisplayName = "Use Half-precision including shader parameters"),
	MFPM_MAX,
};
...
namespace EDynamicGlobalIlluminationMethod
{
	enum Type : int
	{
		...
		ScreenSpace UMETA(DisplayName="Screen Space (Deprecated)"),
...
struct FLightingChannels
{
	...
	UPROPERTY(Interp, EditAnywhere, BlueprintReadOnly, Category=Channels)
	uint8 bChannel0:1;
...
enum EMobileLocalLightSetting : int
{
	...
	LOCAL_LIGHTS_BUFFER UE_DEPRECATED(5.8, "Local Lights Buffer has been deprecated. For local lights heavy games, please use mobile deferred r.Mobile.ShadingPath=1") UMETA(hidden)
};
...
enum EMaterialShadingModel : int
{
	...
	// 13 is reserved by SHADINGMODELID_SUBSTRATE_TOON in the legacy GBuffer.
...
public:
	...
	// Toon profiles
	void AddToonProfile(UToonProfile* InProfile) { if (InProfile) ToonProfiles.Add(InProfile); }
	int32 CountToonProfiles() const { return ToonProfiles.Num(); }
	UToonProfile* GetToonProfile(int32 Index) const { return ToonProfiles.IsValidIndex(Index) ? ToonProfiles[Index] : nullptr; }
...
private:
	...
	TArray<TObjectPtr<UToonProfile>> ToonProfiles;
...
enum ECollisionChannel : int
{
	...
	ECC_GameTraceChannel19 UMETA(Hidden),
	ECC_GameTraceChannel20 UMETA(Hidden),
	ECC_GameTraceChannel21 UMETA(Hidden),
	ECC_GameTraceChannel22 UMETA(Hidden),
	ECC_GameTraceChannel23 UMETA(Hidden),
	ECC_GameTraceChannel24 UMETA(Hidden),
	ECC_GameTraceChannel25 UMETA(Hidden),
	ECC_GameTraceChannel26 UMETA(Hidden),
	ECC_GameTraceChannel27 UMETA(Hidden),
	ECC_GameTraceChannel28 UMETA(Hidden),
	ECC_GameTraceChannel29 UMETA(Hidden),
	ECC_GameTraceChannel30 UMETA(Hidden),
	ECC_GameTraceChannel31 UMETA(Hidden),
	ECC_GameTraceChannel32 UMETA(Hidden),
	ECC_GameTraceChannel33 UMETA(Hidden),
	ECC_GameTraceChannel34 UMETA(Hidden),
	ECC_GameTraceChannel35 UMETA(Hidden),
	ECC_GameTraceChannel36 UMETA(Hidden),
	ECC_GameTraceChannel37 UMETA(Hidden),
	ECC_GameTraceChannel38 UMETA(Hidden),
	ECC_GameTraceChannel39 UMETA(Hidden),
	ECC_GameTraceChannel40 UMETA(Hidden),
	ECC_GameTraceChannel41 UMETA(Hidden),
	ECC_GameTraceChannel42 UMETA(Hidden),
	ECC_GameTraceChannel43 UMETA(Hidden),
	ECC_GameTraceChannel44 UMETA(Hidden),
	ECC_GameTraceChannel45 UMETA(Hidden),
	ECC_GameTraceChannel46 UMETA(Hidden),
	ECC_GameTraceChannel47 UMETA(Hidden),
	ECC_GameTraceChannel48 UMETA(Hidden),
	ECC_GameTraceChannel49 UMETA(Hidden),
	ECC_GameTraceChannel50 UMETA(Hidden),
...
enum EObjectTypeQuery : int
{
	...
	ObjectTypeQuery33 UMETA(Hidden), 
	ObjectTypeQuery34 UMETA(Hidden), 
	ObjectTypeQuery35 UMETA(Hidden), 
	ObjectTypeQuery36 UMETA(Hidden), 
	ObjectTypeQuery37 UMETA(Hidden), 
	ObjectTypeQuery38 UMETA(Hidden), 
	ObjectTypeQuery39 UMETA(Hidden), 
	ObjectTypeQuery40 UMETA(Hidden), 
	ObjectTypeQuery41 UMETA(Hidden), 
	ObjectTypeQuery42 UMETA(Hidden),
	ObjectTypeQuery43 UMETA(Hidden), 
	ObjectTypeQuery44 UMETA(Hidden), 
	ObjectTypeQuery45 UMETA(Hidden), 
	ObjectTypeQuery46 UMETA(Hidden), 
	ObjectTypeQuery47 UMETA(Hidden), 
	ObjectTypeQuery48 UMETA(Hidden), 
	ObjectTypeQuery49 UMETA(Hidden), 
	ObjectTypeQuery50 UMETA(Hidden),
	ObjectTypeQuery51 UMETA(Hidden),
	ObjectTypeQuery52 UMETA(Hidden),
	ObjectTypeQuery53 UMETA(Hidden),
	ObjectTypeQuery54 UMETA(Hidden),
	ObjectTypeQuery55 UMETA(Hidden),
	ObjectTypeQuery56 UMETA(Hidden),
	ObjectTypeQuery57 UMETA(Hidden),
	ObjectTypeQuery58 UMETA(Hidden),
	ObjectTypeQuery59 UMETA(Hidden),
	ObjectTypeQuery60 UMETA(Hidden),
	ObjectTypeQuery61 UMETA(Hidden),
	ObjectTypeQuery62 UMETA(Hidden),
	ObjectTypeQuery63 UMETA(Hidden),
	ObjectTypeQuery64 UMETA(Hidden),
...
enum ETraceTypeQuery : int
{
	...
	TraceTypeQuery33 UMETA(Hidden), 
	TraceTypeQuery34 UMETA(Hidden), 
	TraceTypeQuery35 UMETA(Hidden), 
	TraceTypeQuery36 UMETA(Hidden), 
	TraceTypeQuery37 UMETA(Hidden), 
	TraceTypeQuery38 UMETA(Hidden), 
	TraceTypeQuery39 UMETA(Hidden), 
	TraceTypeQuery40 UMETA(Hidden), 
	TraceTypeQuery41 UMETA(Hidden), 
	TraceTypeQuery42 UMETA(Hidden),
	TraceTypeQuery43 UMETA(Hidden), 
	TraceTypeQuery44 UMETA(Hidden), 
	TraceTypeQuery45 UMETA(Hidden), 
	TraceTypeQuery46 UMETA(Hidden), 
	TraceTypeQuery47 UMETA(Hidden), 
	TraceTypeQuery48 UMETA(Hidden), 
	TraceTypeQuery49 UMETA(Hidden), 
	TraceTypeQuery50 UMETA(Hidden),
	TraceTypeQuery51 UMETA(Hidden),
	TraceTypeQuery52 UMETA(Hidden),
	TraceTypeQuery53 UMETA(Hidden),
	TraceTypeQuery54 UMETA(Hidden),
	TraceTypeQuery55 UMETA(Hidden),
	TraceTypeQuery56 UMETA(Hidden),
	TraceTypeQuery57 UMETA(Hidden),
	TraceTypeQuery58 UMETA(Hidden),
	TraceTypeQuery59 UMETA(Hidden),
	TraceTypeQuery60 UMETA(Hidden),
	TraceTypeQuery61 UMETA(Hidden),
	TraceTypeQuery62 UMETA(Hidden),
	TraceTypeQuery63 UMETA(Hidden),
	TraceTypeQuery64 UMETA(Hidden),
...
struct FCollisionResponseContainer
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel16;    // 29
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel19;    // 32

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel20;    // 33

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel21;    // 34

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel22;    // 35

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel23;    // 36

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel24;    // 37

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel25;    // 38

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel26;    // 39

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel27;    // 40

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel28;    // 41

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel29;    // 42

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel30;    // 43

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel31;    // 44

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel32;    // 45

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel33;    // 46

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel34;    // 47

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel35;    // 48

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel36;    // 49

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel37;    // 50

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel38;    // 51

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel39;    // 52

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel40;    // 53

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel41;    // 54

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel42;    // 55

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel43;    // 56

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel44;    // 57

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel45;    // 58

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel46;    // 59

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel47;    // 60

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel48;    // 61

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel49;    // 62

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=CollisionResponseContainer)
	TEnumAsByte<enum ECollisionResponse> GameTraceChannel50;    // 63
	...
	union
	{
		struct
		{
			...
			uint8 GameTraceChannel19;    // 32
			uint8 GameTraceChannel20;    // 33
			uint8 GameTraceChannel21;    // 34
			uint8 GameTraceChannel22;    // 35
			uint8 GameTraceChannel23;    // 36
			uint8 GameTraceChannel24;    // 37
			uint8 GameTraceChannel25;    // 38
			uint8 GameTraceChannel26;    // 39
			uint8 GameTraceChannel27;    // 40
			uint8 GameTraceChannel28;    // 41
			uint8 GameTraceChannel29;    // 42
			uint8 GameTraceChannel30;    // 43
			uint8 GameTraceChannel31;    // 44
			uint8 GameTraceChannel32;    // 45
			uint8 GameTraceChannel33;    // 46
			uint8 GameTraceChannel34;    // 47
			uint8 GameTraceChannel35;    // 48
			uint8 GameTraceChannel36;    // 49
			uint8 GameTraceChannel37;    // 50
			uint8 GameTraceChannel38;    // 51
			uint8 GameTraceChannel39;    // 52
			uint8 GameTraceChannel40;    // 53
			uint8 GameTraceChannel41;    // 54
			uint8 GameTraceChannel42;    // 55
			uint8 GameTraceChannel43;    // 56
			uint8 GameTraceChannel44;    // 57
			uint8 GameTraceChannel45;    // 58
			uint8 GameTraceChannel46;    // 59
			uint8 GameTraceChannel47;    // 60
			uint8 GameTraceChannel48;    // 61
			uint8 GameTraceChannel49;    // 62
			uint8 GameTraceChannel50;    // 63
		};
		uint8 EnumArray[64];
	};
...
struct FSkeletalMeshBuildSettings
{
	...
	/** If true, optimizes the bone map for lower transform storage memory costs for instancing and enables GPU instanced LOD. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=BuildSettings, AdvancedDisplay)
	uint8 bOptimizeForInstancing:1;
	...
	bool operator==(const FSkeletalMeshBuildSettings& Other) const
	{
		return bRecomputeNormals == Other.bRecomputeNormals
			...
			&& bUseFullPrecisionUVs == Other.bUseFullPrecisionUVs
			&& bUseBackwardsCompatibleF16TruncUVs == Other.bUseBackwardsCompatibleF16TruncUVs
			&& bOptimizeForInstancing == Other.bOptimizeForInstancing
...
enum class EPhysicsReplicationMode : uint8
{
	...
	* Note: Not forward predicted which makes this not viable for ENetRole::ROLE_AutonomousProxy if input latency is of concern.
	* Recommendation: All physics objects that interact should use the same replication mode. Use alongside a kinematic pawn (not physics simulated).
	...
	* Enable Project Settings > Physics Prediction for best result */
	PredictiveInterpolation = 1 UMETA(DisplayName = "Predictive Interpolation"),
	...
	* Recommendation: All physics objects that interact should use the same replication mode. Use on physics simulated pawns along with any physics objects that will interact with such pawns.
	* Available when Project Settings > Physics Prediction is enabled. */
	Resimulation = 2 UMETA(DisplayName = "Resimulation (WIP)"),

	/** Don't apply physics replication
	* Note: Can be used to temporarily disable physics replication for specific actors. */
