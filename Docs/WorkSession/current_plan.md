...
```
Layer 1：全局架构图       → Docs/Architecture/SystemDependencyMap.md
Layer 2：系统接口卡片     → Docs/Systems/{System}/*_Architecture.md
Layer 3：导演接口汇总     → Docs/Systems/Director/DirectorInterfaces.md  ← 核心输出
```
...
**1a. 存档系统** → `Docs/Systems/Save/SaveSubsystem_Architecture.md`
...
**1b. 元进度系统** → `Docs/Systems/MetaProgression/MetaProgression_Architecture.md`
...
**1c. 故事引擎** → `Docs/Systems/Story/StoryEngine_Architecture.md`
...
→ `Docs/Architecture/SystemDependencyMap.md`
...
→ `Docs/Systems/Director/DirectorInterfaces.md`
...
→ `Docs/Architecture/DocConventions.md`
...
- `Docs/Architecture/SystemDependencyMap.md` — 全局系统依赖图
- `Docs/Architecture/DocConventions.md` — 文档维护规范
- `Docs/Systems/Save/SaveSubsystem_Architecture.md` — 存档系统架构
- `Docs/Systems/MetaProgression/MetaProgression_Architecture.md` — 元进度系统架构
- `Docs/Systems/Story/StoryEngine_Architecture.md` — 故事引擎架构
- `Docs/Systems/Director/DirectorInterfaces.md` — 导演接口汇总（核心输出）
