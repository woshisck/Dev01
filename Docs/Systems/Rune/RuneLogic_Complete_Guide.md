...
> 定位：从概念到配置的完整符文开发手册  
> 前置文档：[Rune_System_Design](../../Design/Rune/Rune_System_Design.md)（设计框架）、[TestRune_CreationGuide](TestRune_CreationGuide.md)（已实现符文）
...
通过 SubGraph 隔离复用基础效果 FA，详见 [StatusEffect_EngineConfig_Guide](../../Design/StatusEffects/StatusEffect_EngineConfig_Guide.md)。
...
| [StatusEffect_EngineConfig_Guide](../../Design/StatusEffects/StatusEffect_EngineConfig_Guide.md) | 10 个基础效果 FA + SubGraph 复用模式 |
| [Rune_System_Design](../../Design/Rune/Rune_System_Design.md) | 符文设计框架（4 流派 + 维度分析） |
| [Rune_Archetype_Catalog](../../Design/Rune/Rune_Archetype_Catalog.md) | 流派符文目录（概念设计） |
| [BuffFlow_NodeUsageGuide](BuffFlow_NodeUsageGuide.md) | BFNode 详细用法指南 |
| [BackpackSystem_Guide](BackpackSystem_Guide.md) | 背包系统配置 |
