...
| 技术文档 | [EUW_CombatLog_Technical.md](../04_开发实现与系统文档/系统/UI/EUW_CombatLog_Technical.md)、[WBP_EUW_CombatLog_Layout.md](../04_开发实现与系统文档/系统/UI/WBP_EUW_CombatLog_Layout.md) |
...
| 项目 | 内容 |
|------|------|
| 涉及文件 | `Source/.../DamageExecution.cpp`、`Source/.../GA_Dead.cpp`、`Source/.../BackpackGridComponent.cpp`、`Config/DefaultGameplayTags.ini`、`Config/Tags/BuffTag.ini`、`Docs/04_开发实现与系统文档/系统/Rune/EnemyBuff_ProductionGuide.md` |
...
| 项目 | 内容 |
|------|------|
| 核心文件 | `UI/PortalPreviewWidget.cpp`、`Docs/04_开发实现与系统文档/系统/Level/WBP_PortalPreview_Layout.md` |
...
| 撤回的删除（文档） | 当时旧路径：`Docs/Survey/01-06_*.md`（玩家研究问卷依据）、`Docs/04_开发实现与系统文档/系统/Rune/BackpackUI_Architecture.md`、`Docs/04_开发实现与系统文档/系统/Level/WBP_PortalPreview_Layout.md`、`Docs/04_开发实现与系统文档/系统/UI/WBP_LootSelection_Layout.md` 等 |
...
| 待定决策 | [PendingDecisions.md](../00_入口与规范/缺失引用记录.md) DEC-001：背包详情卡通用效果默认展开（待玩家测试反馈再评审） |
...
| 设计文档 | [HitStop_Design.md](../02_玩法设计与调研/设计文档/Combat/HitStop_Design.md) |
...
| 设计文档 | `Docs/02_玩法设计与调研/设计文档/Combat/HitStop_Design.md` |
...
| 技术文档 | [CharacterFlash_Technical](../04_开发实现与系统文档/系统/VFX/CharacterFlash_Technical.md) |
...
| 技术文档 | [LootSelection_Technical](../04_开发实现与系统文档/系统/UI/LootSelection_Technical.md) |
...
设计文档：[充能系统指南](../04_开发实现与系统文档/系统/Combat/SkillCharge_Guide.md)
...
详见 [液态玻璃框技术文档](../04_开发实现与系统文档/系统/UI/GlassFrame_Technical.md)
...
| 设计文档 | [BackpackUI_StepByStep.md](../99_归档/旧方案/2D背包方案/BackpackUI_StepByStep.md) |
...
| 设计文档 | [CharacterFlash_Technical.md](../04_开发实现与系统文档/系统/VFX/CharacterFlash_Technical.md) |
...
| 设计文档 | [Camera_Design.md](../04_开发实现与系统文档/系统/Camera/Camera_Design.md) |
...
| 设计文档 | [BackpackGamepadAndUI.md](../00_入口与规范/缺失引用记录.md) |
...
| 设计文档 | [Camera_Design.md](../04_开发实现与系统文档/系统/Camera/Camera_Design.md)（v2.1） |
...
| 设计文档 | [CommonUI重构工作报告](../00_入口与规范/缺失引用记录.md) |
...
| 设计文档 | [MainLoop_Design.md](../00_入口与规范/缺失引用记录.md) |
...
| 设计文档 | [AttackDamage_Design.md](../00_入口与规范/缺失引用记录.md) |
...
| 设计文档 | [Dash_Design.md](../04_开发实现与系统文档/系统/Combat/Dash_Design.md) |
...
| 设计文档 | [BackpackSystem_Technical.md](../99_归档/旧方案/2D背包方案/BackpackSystem_Technical.md) |
...
| 设计文档 | [Portal_Design.md](../00_入口与规范/缺失引用记录.md) |
...
| 配置文档 | [PoiseSystem_ConfigGuide.md](../04_开发实现与系统文档/系统/Combat/PoiseSystem_ConfigGuide.md) |
...
| 设计文档 | [BackpackSystem_Guide.md](../99_归档/旧方案/2D背包方案/BackpackSystem_Guide.md) §六 |
...
| 设计文档 | [Tutorial_Design.md](../00_入口与规范/缺失引用记录.md) |
