...
- 新建 `Docs/01_长期系统文档/系统/*` 与既有 `Docs/01_长期系统文档/系统/Story/*` 可能形成双份 StoryEngine 文档，后续容易漂移。
...
- 现有 `Docs/01_长期系统文档/系统/*` 和 `Docs/99_归档/旧方案/旧根目录入口/Architecture/*` 是否就是本计划的执行产物？如果是，本轮应审校这些文件，而不是按“新建文件”执行。
