...
| `Action.Knockback` | ⭐ 建议新增：触发击退 GA 的事件信号 |
...
| `State.Dead` | `PlayerState.AbilityCast.*` | `PlayerState.AbilityCast.*` | 999 | 死亡优先级最高 |
