	...
	static const FAbilityDataAssetSpec Specs[] = {
		{
			...
			{
				{ TEXT("Character.State.Skill.Attack.Combo1"), TEXT("/Game/Animation/1H-2HSword/Montage/1H_Attack_01_Seq_Montage") },
				{ TEXT("Character.State.Skill.Attack.Combo2"), TEXT("/Game/Animation/1H-2HSword/Montage/1H_Attack_02_Seq_Montage") },
				{ TEXT("Character.State.Skill.Attack.Combo3"), TEXT("/Game/Animation/1H-2HSword/Montage/1H_Attack_03_Seq_Montage") },
				{ TEXT("Character.State.Skill.Attack.Combo4"), TEXT("/Game/Animation/1H-2HSword/Montage/1H_Attack_04_Seq_Montage") },
				{ TEXT("Character.State.Movement.Dash.Combo1"), TEXT("/YogAnimSource/ElianAnim/Common/AM_Common_Dash_Seq_01") },
				{ TEXT("Character.State.Movement.Dash.Combo2"), TEXT("/YogAnimSource/ElianAnim/Common/AM_Common_Dash_Seq_01") },
				{ TEXT("Character.State.Movement.Dash.Combo3"), TEXT("/YogAnimSource/ElianAnim/Common/AM_Common_Dash_Seq_01") },
				{ TEXT("Character.State.Movement.Dash.Combo4"), TEXT("/YogAnimSource/ElianAnim/Common/AM_Common_Dash_Seq_01") },
				{ TEXT("Character.State.Movement.Dash"), TEXT("/YogAnimSource/ElianAnim/Common/AM_Common_Dash_Seq_01") },
				{ TEXT("Character.State.Equipment.SwitchWeapon"), TEXT("") },
			},
			{},
		},
		{
			...
			{
				{ TEXT("Character.State.Skill.WeaponSkill.Combo1"), TEXT("/Game/Animation/1H-2HSword/Montage/1H_Guard_01_Seq_Montage") },
				{ TEXT("Character.State.Skill.WeaponSkill.Combo2"), TEXT("/Game/Animation/1H-2HSword/Montage/1H_Attack_06_Seq_Montage") },
				{ TEXT("Character.State.Skill.WeaponSkill.Combo3"), TEXT("/Game/Animation/1H-2HSword/Montage/1H_Attack_07_Seq_Montage") },
				{ TEXT("Character.State.Skill.WeaponSkill.Combo4"), TEXT("/Game/Animation/1H-2HSword/Montage/1H_Attack_08_Seq_Montage") },
			},
			{
