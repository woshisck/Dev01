...
namespace Rune512Batch
{
		...
		TArray<UPackage*>& DirtyPackages)
	{
		...
		for (const TPair<FGuid, UFlowNode*>& Pair : FlowAsset->GetNodes())
		{
			...
			SlashNode->bEnableTargetedBounce = false;
			...
			case EMoonlightFlowProfile::ForwardShield:
				...
				SlashNode->VisualScaleMultiplier = FVector(0.85f, 0.85f, 0.85f);
				SlashNode->ProjectileVisualNiagaraScale = FVector(0.85f, 0.85f, 0.85f);
				SlashNode->bEnableTargetedBounce = true;
				SlashNode->TargetedBounceMaxCount = 5;
				SlashNode->TargetedBounceSearchRadius = 650.f;
				SlashNode->TargetedBounceMaxTravelDistance = 650.f;
				SlashNode->bAddComboStacksToProjectileCount = true;
		...
		URuneCardEffectProfileDA* Profile)
	{
		...
		Projectile.bEnableTargetedBounce = SlashNode->bEnableTargetedBounce;
		Projectile.TargetedBounceMaxCount = SlashNode->TargetedBounceMaxCount;
		Projectile.TargetedBounceSearchRadius = SlashNode->TargetedBounceSearchRadius;
		Projectile.TargetedBounceMaxTravelDistance = SlashNode->TargetedBounceMaxTravelDistance;
