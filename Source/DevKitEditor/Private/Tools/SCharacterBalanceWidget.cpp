...
namespace
{
	...
	const TArray<FCharacterFieldDef>& GetBaseFieldDefs()
	{
		static const TArray<FCharacterFieldDef> Fields =
		{
			...
			{ TEXT("AttackSpeed"),  TEXT("AttackSpeed"),  TEXT("攻击速度"),     TEXT("Linear attack speed stat. 100 = 1.0 montage rate, 200 = 2.0."), TEXT("[f]AttackSpeed"),  TEXT("all"), 100.f, 0.f,    200.f,  true, ECharacterFieldSource::BaseAttributes },
