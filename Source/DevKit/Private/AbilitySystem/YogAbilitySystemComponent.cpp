...
void UYogAbilitySystemComponent::OnTagUpdated(const FGameplayTag& Tag, bool TagExists)
{
	...
	// =========================================================
	// ��Ϸ��ࣺTag ����/��ʧʱ�� BlockCategoryMap ִ�ж�Ӧ���
	// =========================================================
	...
	// =========================================================
	// SuperArmor Fresnel ���⣺tag ��/���Զ� Start/Stop��ͳһ����
	// C++ Poise �Զ�����·���� FA AddTag ·����������η���� E001��
	// =========================================================
	{
...
{
	// �� SetLooseGameplayTagCount(Tag, 0) ���㣬���� RemoveLooseGameplayTag ֻ��һ�μ������²���
	static const FGameplayTag MeleeTag  = FGameplayTag::RequestGameplayTag(TEXT("Weapon.Type.Melee"),  false);
	static const FGameplayTag RangedTag = FGameplayTag::RequestGameplayTag(TEXT("Weapon.Type.Ranged"), false);
...
void UYogAbilitySystemComponent::BeginDealtDamageAccumulation()
{
...
{
	if (!bAccumulatingDealtDamage || HealthDamage <= AccumulatedMaxHealthDamage)
	{
		return;
	}
	AccumulatedMaxHealthDamage = HealthDamage;
	...
	const FGameplayEffectContextHandle& DamageContext)
{
	...
	// �㲥ǰ��� TargetASC (this) ���� Avatar �Ƿ���Ȼ��Ч
	// ͬ֡�ڶ��������������ɫ��DoT/AoE���ᵼ�� TargetASC pending kill��
	// Blueprint ��� GA_Passive_knockback ���� pending kill ����ᱨ��
	...
	if (SourceASC)
	{
		...
		SourceASC->CurrentActionPoiseBonus = 0.f; // ��ȡ���������㣬�����֡����
	}
	...
	if (bEnemyDefender && !bHadBlockingSuperArmor)
	{
		...
		if (SuperArmorThreshold > 0 && PoiseHitCount >= SuperArmorThreshold)
		{
			...
			// AddLooseGameplayTag �ᴥ�� OnTagUpdated �� �Զ� StartSuperArmorFlash
	...
	// =========================================================
	// �����ܻ��¼���Action.HitReact.Front / .Back ���Ӽ���
	// =========================================================
...
void UYogAbilitySystemComponent::OnSuperArmorTimerEnd()
{
	...
	// RemoveLooseGameplayTag �ᴥ�� OnTagUpdated �� �Զ� StopSuperArmorFlash
...
bool UYogAbilitySystemComponent::TryActivateRandomAbilitiesByTag(const FGameplayTagContainer& GameplayTagContainer, bool bAllowRemoteActivation)
{
	...
	{
		// �� Tag ģʽ��OR ���壬��ÿ�� Tag ��Ϊ������ѡ���ֱ����ƥ�� GA������ȥ�غ��������һ��
		// �÷����� {Enemy.Melee.LAtk1, Enemy.Melee.LAtk2, Enemy.Melee.LAtk3}
		//      �� �������ֹ��������ѡһ��
	...
	{
		// �� Tag ģʽ��ԭ����Ϊ����֧�ָ� Tag ƥ�������Ӽ� GA
		// �÷����� {Enemy.Melee} �� ������ Enemy.Melee.* GA �����ѡһ��
...
void UYogAbilitySystemComponent::LogDamageDealtDetailed(AActor* Target, const FDamageBreakdown& Breakdown)
{
	...
	// ��ʽ��[���2]  25 �� 0.88 �� 1.00 ��CRIT = 44.0  �� BP_Enemy_Rat
