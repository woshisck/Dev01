...
bool UYogWorldSubsystem::checkRange(int index)
{
	return false;
}
...
void UYogWorldSubsystem::SetupMatrixElement(int x, int y, ESublevelType Type, FSoftObjectPath soft_object_path)
{
	LevelMatrix[x - 1][y - 1].LevelMapSoftPath = soft_object_path;
	LevelMatrix[x - 1][y - 1].NodeType = Type;
}
