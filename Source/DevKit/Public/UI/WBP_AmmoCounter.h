...
#include "WBP_AmmoCounter.generated.h"
 ...
 * Musket ammo HUD.
 *
 * The Blueprint child only needs a HorizontalBox named BulletIconBox.
 * By default the widget is hidden until the owning player has Weapon.Type.Ranged.
 */
UCLASS()
class DEVKIT_API UWBP_AmmoCounter : public UUserWidget
{
	GENERATED_BODY()
