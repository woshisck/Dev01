...
public:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Animation|Fold", meta = (ClampMin = "0"))
	...
	UPROPERTY(EditDefaultsOnly, Category = "Animation|Shrink", meta = (ClampMin = "0"))
	float ShrinkDuration = 0.35f;

	/** 飞行终点的玻璃图标尺寸（px，影响缩小目标 Scale） */
	UPROPERTY(EditDefaultsOnly, Category = "Animation|Shrink")
	...
	UPROPERTY(EditDefaultsOnly, Category = "Animation|Fly", meta = (ClampMin = "0"))
	 ...
	 */
	UPROPERTY(EditDefaultsOnly, Category = "Animation|Fly")
	...
	UPROPERTY(EditDefaultsOnly, Category = "Animation|Fade Out", meta = (ClampMin = "0"))
	float ExpandDuration = 0.20f;

	/** 消失时放大倍率 */
	UPROPERTY(EditDefaultsOnly, Category = "Animation|Fade Out",
