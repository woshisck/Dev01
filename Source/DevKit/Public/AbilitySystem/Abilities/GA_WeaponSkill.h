...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Weapon Skill", meta = (DisplayName = "获取已装备战技数据"))
	const UWeaponSkillDataAsset* GetEquippedWeaponSkillData() const;

	/** Stable authoring identity used by the YogTool weapon manager. */
	UFUNCTION(BlueprintPure, Category = "Weapon Skill|Authoring Constraints", meta = (DisplayName = "获取战技标签"))
	FGameplayTag GetWeaponSkillTag() const { return WeaponSkillTag; }

	UFUNCTION(BlueprintPure, Category = "Weapon Skill|Authoring Constraints", meta = (DisplayName = "获取战技显示名称"))
	FText GetWeaponSkillDisplayName() const { return WeaponSkillDisplayName; }

	UFUNCTION(BlueprintPure, Category = "Weapon Skill|Authoring Constraints", meta = (DisplayName = "获取战技简介"))
...
protected:
	 ...
	 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Weapon Skill|Authoring Constraints", meta = (Categories = "Weapon.Skill", DisplayName = "战技标签"))
	FGameplayTag WeaponSkillTag;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Weapon Skill|Authoring Constraints", meta = (DisplayName = "中文名称"))
	FText WeaponSkillDisplayName;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Weapon Skill|Authoring Constraints", meta = (MultiLine = true, DisplayName = "中文简介"))
	FText WeaponSkillDescription;

	/** Montage keys that this GA can consume from its dedicated AbilityData. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Weapon Skill|Authoring Constraints", meta = (DisplayName = "必需蒙太奇槽位"))
	 ...
	 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Weapon Skill|Authoring Constraints", meta = (DisplayName = "专属战技 DA 类型"))
