 ...
 * 火枪战技蓄力瞄准 GA。
 *
 * Native class name is legacy compatibility; runtime input treats this as WeaponSkill,
 * not a separate heavy-attack branch.
 *
 * 工作流：
...
public:
    ...
    static FGameplayTag GetWeaponSkillReleaseEventTag();
    static TArray<FGameplayTag> GetReleaseEventTags();

    /** 瞄准弧指示器 Actor 类（Blueprint 填写 BP_AimArcActor 子类） */
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Musket|WeaponSkill")
